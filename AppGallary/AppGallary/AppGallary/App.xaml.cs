...
using AppGallary.Resources.Controls;
        ...
        public static List<PaginaColecao> MenuItensColecao
        {
            get
            {
                ...
                var leiautes = new PaginaColecao()
                {
                    ...
                    new Pagina() { Nome = "ScrollView", Descricao = "Adicione barra de rolagem ao seu conteúdo", ArquivoPagina = typeof(XamarinForms.Layouts.BarraDeRolagemLayout.BarraDeRolagem), TemNavegacao = true },
                ...
                var controles = new PaginaColecao()
                {
                    ...
                    new Pagina() { Nome = "Editor", Descricao = "Controle de entrada de texto em várias linhas", ArquivoPagina = typeof(XamarinForms.Controles.CampoDeEntradaMultLineControle.CampoDeEntradaMultLine), TemNavegacao = true },
                ...
                var classesuteis = new PaginaColecao()
                {
                    ...
                    new Pagina() { Nome = "MessageCenter", Descricao = "Troque mensagens entre telas de forma elegante", ArquivoPagina = typeof(XamarinForms.Classes.CentroDeMensagem.Pagina01), TemNavegacao = true },
                ...
                var instagram = new PaginaColecao()
                {
                    new Pagina() { Nome = "Instagram", Descricao = "Replicação do Instagram", ArquivoPagina = typeof(XamarinForms.Instagram.Home.Home), TemNavegacao = false }
                };
                classesuteis.Nome = "Instagram";
